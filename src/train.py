...
def train(data_dir, model_dir, args):
    ...
    scheduler = StepLR(optimizer, args.lr_decay_step, gamma=0.794) #1e-3 to 1e-5 면 1/100이니깐 0.5씩 20번
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='EffiNetb0', help='model type (default: BaseModel)')
